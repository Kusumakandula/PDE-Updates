...
def generate_styled_table_html(df):
    ...
    # Fixed pixel widths (adjusted to avoid overflow)
    col_width_map = {
        "Week": "80px",
        "Account Name": "100px",
        "Client Name": "100px",
    ...
    wrap_col_width = "150px"  # Free-text columns

    table_html = """
    <div style='display: flex; justify-content: center;'>
        <table style='border-collapse: collapse; font-family: Arial, sans-serif; font-size: 9px; table-layout: fixed; width: 100%; max-width: 1000px;'>
    """
    ...
    for col in columns:
        ...
        # ❗ ADD nowrap style ONLY for this column
        nowrap = "white-space: nowrap;" if col == "Customer Sentiment Rating" else ""
